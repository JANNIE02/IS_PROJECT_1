...
// Usage:  <?php include 'profile_avatar.php'; 
//
...
// without leaving the dashboard page. Saving posts to update_profile.php,
...
// Fetch full profile details for pre-filling the popup
$profile = null;
if (isset($conn)) {
    $res = pg_query_params(
        $conn,
